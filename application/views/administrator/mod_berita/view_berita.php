                ...
                <div class="box-body">
                  ...
                  <?php 
                    ...
                    echo "<tr><td>$no</td>
                              ...
                              <td>$status</td>
                              <td><center>
                                <a class='btn btn-primary btn-xs' title='Edit Data' href='".base_url()."administrator/publish_listberita/$row[id_berita]/$row[status]'><span class='glyphicon glyphicon-ok'></span></a>
