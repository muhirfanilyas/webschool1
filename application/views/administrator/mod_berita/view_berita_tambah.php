    ...
    echo "<div class='col-md-12'>
          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Tag</th>                    <td><input type='text' class='form-control' name='j' placeholder='Contoh : nasional, olahraga, sosial, budaya, dll'><small><i>Tag Pisah dengan koma jika banyak tag.</i></small></td></tr>
                  </tbody>
                  </table>
                </div>
